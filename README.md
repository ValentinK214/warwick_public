...
## BSc Thesis: OLTP workload mapping for database tuning
...
- **Please open:**
    ...
    - [Thesis](https://github.com/ValentinK214/warwick_public/blob/main/thesis/thesis_final_submission.pdf) for the actual 97 page report
